...
f)if(f.time-b.time<1E3&&Math.abs(b.coords[0]-f.coords[0])>30&&Math.abs(b.coords[1]-f.coords[1])<100)b.origin.trigger("swipe").trigger(b.coords[0]>f.coords[0]?"swipeleft":"swiperight");b=f=undefined})})}};
